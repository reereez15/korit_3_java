...
//        System.out.println(num2);
        ...
        // 빈 배열 nums 를 선언하시고 1~10까지 집어넣어주세요.
        // 그리고 1 2 3 4 ...10 으로 출력할 수 있게끔
        // 일반 for문 , 향상된 for문으로 작성
        int[] nums = new int[10];
        // element 집어 넣는거
        // 일반 for 문
        ...
        System.out.println();
        // 배열 전체 출력 방법
        System.out.println(Arrays.toString(nums));  // 보기만 할때 사용<<

//        int[] numbers = { 4, 7, 1, 9, 6, 2, 5, 8, 10, 3, };
        ...
        // 그 결과값을 변수에 대입해왓지만 .sort() 메서드의 경우 numbers 배열의
        ...
        // 오른차순 시에 사용했던 sort()와 마찬가지로 배열 자체를 다 바꿉니다.
