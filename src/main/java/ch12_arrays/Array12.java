...
public class Array12 {
    public static void main(String[] args) {
        // Math 클래스를 사용하는 임의의 실수 대입
//        double a = Math.random();   // 0.0초과 1.0 미만의 난수 생성해서 반환
//        System.out.println(a);
        ...
        /*
            ...
            0.0 < a < 1.0   에서 10곱해주고
            0.0 < a <10.0   에서 1더해줍니다
            1.0 < a <11.0   그럼 이렇게 되는데 이걸 int로 형변환하면되지요.
         */
        // 1<= a <= 사이의 난수를 numbers에 대입하는 반복문 작성
        ...
        for (int number : numbers){
            ...
            sum += number;
            // 여기에 바로 evenSum을 구하기 위한 조건문을 작성 할 수도 잇겠죠.
            if (number % 2 == 0){
                evenSum += number;
            }
        }
