...
import ch13_abstraction.abstraction_class.Factory;
import ch13_abstraction.abstraction_class.PhoneFactory;
...
public class Main {
    public static void main(String[] args) {
        ...
        PhoneFactory phoneFactory1 = new PhoneFactory("애플 스마느폰 공장");
